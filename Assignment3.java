...
public class Assignment3 {
	...
	public static void main(String[] args) {
        ...
        driver.findElement(By.id("createLeadForm_companyName")).sendKeys("Duplicatingcompanyname");
        driver.findElement(By.id("createLeadForm_firstName")).clear();
        driver.findElement(By.id("createLeadForm_firstName")).sendKeys("AnushaReddy");
